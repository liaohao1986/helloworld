...
public class CodeGenerator {
    ...
    //特别注意:由于getColumns大小写敏感，所以一定要写数据库实际的表名称 airport_normal  manual_pay_record
    private final static String tableName = "booking_sms";
    // mysql oracle
    ...
    public StringBuilder generateJavaObject() {
        ...
        entityBuilder.append("}\r\n");
        //输出到文件中
        String packageName = CodeGenerator.class.getPackage().getName().replace(".", "\\");
    ...
    private void fillJavaHeadComment(StringBuilder builder) {
        ...
        builder.append(" * generated by CodeGenerator<br>\n");
        builder.append(" */\n");
    }
    ...
    public static void main(String[] args) throws IOException {
        CodeGenerator bean = new CodeGenerator();
